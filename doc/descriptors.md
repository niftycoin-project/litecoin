# Support for Output Descriptors in NiftyCoin Core

Since NiftyCoin Core v0.17, there is support for Output Descriptors in the
...
on NiftyCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing NiftyCoin Core wallets, a convenience function `combo` is
