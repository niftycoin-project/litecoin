...
"""Verify that starting niftycoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start niftycoin with -h for help text")
        ...
        self.log.info("Start niftycoin with -version for version information")
        ...
        self.log.info("Start niftycoind with -fakearg to make sure it does not start")
