...
#if defined(NDEBUG)
# error "NiftyCoin cannot be compiled without assertions."
#endif
...
static constexpr int64_t STALE_CHECK_INTERVAL = 365 * 24 * 60 * 60; // PIN - updated temporary from 2.5 minutes (2.5 * 60) to a year
...
static constexpr int STALE_RELAY_AGE_LIMIT = 365 * 24 * 60 * 60; // PIN - updated temporary from 30 days (30 * 24 * 60 * 60) to a year
