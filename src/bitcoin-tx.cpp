...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s niftycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  niftycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded niftycoin transaction") + "\n" +
              "  niftycoin-tx [options] -create [commands]   " + _("Create hex-encoded niftycoin transaction") + "\n" +
              "\n";
