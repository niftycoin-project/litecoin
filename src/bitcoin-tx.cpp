...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " niftycoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  niftycoin-tx [options] <hex-tx> [commands]  Update hex-encoded niftycoin transaction\n" +
            "or:     niftycoin-tx [options] -create [commands]   Create hex-encoded niftycoin transaction\n" +
            "\n";
